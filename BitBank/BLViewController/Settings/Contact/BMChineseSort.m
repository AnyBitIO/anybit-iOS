...
+(NSMutableArray*)ReturnSortObjectArrar:(NSArray*)stringArr key:(NSString *)key{
    ...
    //add by zmm
    BMChineseSort *firsrChineseString = [chineseStringsArray firstObject];
    if ([firsrChineseString.pinYin isEqualToString:@"#"])
    {
        [chineseStringsArray removeObject:firsrChineseString];
        [chineseStringsArray addObject:firsrChineseString];
    }
    //
