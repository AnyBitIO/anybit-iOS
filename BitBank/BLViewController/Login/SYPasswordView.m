...
- (void)initPwdTextField
{
    ...
    //生成分割线
    for (int i = 0; i < 7; i++) {
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMinX(self.textField.frame) + i * width, 0, 1, K_Field_Height)];
...
{
    if (!_textField) {
        _textField = [[NoCopyPasteTextField alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, K_Field_Height)];
